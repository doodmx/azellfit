...
CONTENT;
            ...
            ->editColumn('status', function ($data) {
                ...
                $color = $data->status == 1 ? 'lime-green' : 'primary';
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            'Título'             => ['name' => 'title', 'data' => 'title', 'class' => 'white-text'],
            'Fecha de publicación' => ['name' => 'date_to_publish', 'data' => 'date_to_publish', "class" => "text-center white-text"],
