@if(session()->has('cart'))
    ...
    <li class="nav-item dropdown notifications-na col-12 col-lg">
        ...
        <div class="dropdown-menu dropdown-menu-right bg-tangaroa" aria-labelledby="cartDropdown">
            ...
            @foreach(collect(session()->get('cart')['items'])->slice(0,2) as $cartItem)
                <div class="dropdown-item waves-effect waves-light d-flex justify-content-between align-items-center">
                    ...
                    <div class="flex-grow-1 px-3 left">
                        <p class="font-weight-bolder my-0 white-text">
        ...
        <!--CART ToTAL-->
            <div class="dropdown-item waves-effect waves-light d-flex justify-content-between align-items-center">
                ...
                <div class="lead white-text">Total</div>
            ...
            <a class="dropdown-item white-text text-center mt-1"
            ...
            <button type="button" class="dropdown-item white-text text-center mt-1 btn-empty-cart">
