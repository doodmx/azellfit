...
@section('content')
    ...
    <div class="row justify-content-center align-items-center  p-5">
        ...
        <div class="col-sm-6">
            <img src="{{asset('img/work_500.svg')}}" class="img-fluid" alt="404 error">
        </div>
    </div>
    ...
    {{--
        <div class="card bg-dark rounded mx-5 mx-md-0">
            <div class="card-body p-0 text-center">
                ...
                <div class="px-5">
                    <h1 class="mt-3 red-text font-weight-bold display-1">500</h1>
                    <h3 class="red-text">
                        Ocurrió un error en el servidor, contacte al administrador del sitio.
                    </h3>
