...
<div class="card course-price-card" id="coursePrice">
    ...
    <!--CARD BODY -->
    <div class="card-body bg-black-pearl p-0">
    ...
    <!--COURSE PREVIEW -->
        ...
        <div class="p-0 p-lg-4 text-left">
            ...
            <div class="title">
                ...
                <h2 class="text-lime-green font-weight-bolder">
                ...
                @if(auth()->guest())
                    ...
                    <a href="{{route('register')}}"
                       class="btn btn-lg btn-lime-green text-tangaroa mt-lg-3 purchase-btn">
                    ...
                    @else
                        ...
                        @else
                            ...
                            <input type="hidden" name="thumbnail"
                                   value="{{asset('storage/courses/'.$course->thumbnail)}}">
