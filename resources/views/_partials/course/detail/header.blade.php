<div class="bg-black-pearl p-3 p-sm-5 rounded">

    <h1 class="text-lime-green font-weight-bold">{{$course->name}}</h1>
    <h5 class="mt-2 white-text font-weight-bold">
        {{__('courses/detail.author')}}
        {{$course->instructor->profile->lastname}}
        {{$course->instructor->profile->name}}
    </h5>

    <p class="mt-3 lead white-text text-justify">
        {{$course->excerpt}}
    </p>
