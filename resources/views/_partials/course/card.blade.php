<div class="card bg-transparent">
    ...
    <div class="view">
        ...
        <a href="{{$route}}">
            <div class="mask rgba-black-light waves-effect waves-light"></div>
        </a>
    ...
    <a
            href="{{$route}}"
            class="btn-floating btn-action btn-lime-green  ml-auto mr-4 waves-effect waves-light"
    >
        <i class="fas fa-chevron-right pl-1 text-tangaroa"></i>
    </a>
    <!-- Card content -->
    <div class="card-body bg-black-pearl white-text text-left">

        <!-- Title -->
        <h4 class="card-title text-lime-green font-weight-bold text-uppercase mt-3">{{$course->name}}</h4>
        @if($rate>0)
        ...
        @if(!empty($progress) && ($progress > 0  && $progress < 100 ))
            <div class="mb-3">
                ...
                <p class="text-small text-right white-text mt-1 font-weight-bold">
                    {{$progress}}%
                </p>
            </div>
    @endif
    ...
    <!-- Text-->
        <p class="card-text mb-0 white-text mt-3 text-justify">
            {{$course->excerpt}}
        </p>
    </div>
    <!-- Card content -->
    ...
    <!-- Card footer -->
    <div class="card-footer white-text rounded-bottom p-3">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            @if($rate == 0 && intval($progress) === 100)
                <div>
                    <button type="button"
                            id="openRateModal"
                            class="btn btn-lime-green btn-sm text-tangaroa font-weight-bold"
