    ...
    <div class="main-content">
        ...
        @if(request()->session()->has('success_cart'))
            <div class="row no-gutters">
                <div class="col-12">
                    <div class="alert bg-lime-green lead text-tangaroa" role="alert">
        ...
        <div class="card bg-transparent">
            <div class="card-body bg-black-pearl rounded cart">
                <div id="header" class="pt-3 pl-3">
                    <h1 class="text-lime-green">
                ...
                <div class="container mt-5">
                    ...
                    @if(empty($cart))
                        <div class="my-5 text-center">
                            <i class="fas fa-shopping-cart fa-5x text-lime-green"></i>
                            <h3 class="text-lime-green font-weight-bold mt-3">
                    ...
                    @if(isset($cart['items']))
                        <div class="row wrap bg-lime-green text-tangaroa p-3 lead rounded d-none d-lg-flex">
                        ...
                        @foreach($cart['items'] as $cartItem)
                            ...
                            <div class="row wrap justify-content-between align-items-center white-text lead text-center mt-5 mt-lg-0 item">
                                ...
                                <div class="totals col-12 col-lg-10 d-flex row no-gutters mt-5 mt-lg-0">
                    ...
                    @if(isset($cart['totals']))
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-12 col-lg-4 p-lg-0">
                                <div class="card bg-transparent">
                                    <div class="card-body bg-black-pearl">
                                        <h3 class="text-lime-green">{{__('cart.totals')}}</h3>
                                    ...
                                    <div class="card-body bg-black-pearl">
                                        ...
                                        <h5 class="mb-3">
                                            ...
                                            <div class="mb-0 d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="text-center text-md-left white-text">
                                        ...
                                        <button type="button" id="btnCheckout"
                                                class="btn btn-block btn-lime-green text-tangaroa mt-5">
                                            {{__('cart.pay')}}
                                        </button>
