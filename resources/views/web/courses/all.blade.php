...
@section('content_without_section')
    ...
    <div class="d-flex flex-column flex-1 courses-container">
        ...
        <div class="d-flex flex-1" style="overflow-y: hidden;">
            ...
            <div class="col-3 bg-black-pearl p-4 shadow-lg">


                <ul class="list-group list-group-flush mt-3">
                    <li class="list-group-item bg-black-pearl text-zircon text-uppercase font-weight-bold border-0 mb-0">
                        <a class="text-zircon" href="{{route('web.courses.all')}}">
                            {!!  __('courses/index.recents') !!}
                        </a>
                    </li>
                    <li class="list-group-item bg-black-pearl text-zircon text-uppercase font-weight-bold border-0">
                ...
                <h4 class="text-lime-green font-weight-bold mt-3">
